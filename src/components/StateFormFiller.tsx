...
const STATE_FORMS: Record<string, {
  ...
  'California': {
    ...
    fields: [
      ...
      { id: 'ownerName', label: 'True Full Name (Last, First, Middle, Suffix)', mappedField: 'Owner Last Name', type: 'text', required: true },
      { id: 'driverLicense', label: 'Driver License/ID Card Number', type: 'text' },
      { id: 'dlState', label: 'State', type: 'text' },
      { id: 'coOwnerName', label: 'Co-Owner True Full Name', mappedField: 'Co-Owner Last Name', type: 'text' },
      { id: 'coOwnerDL', label: 'Co-Owner Driver License/ID Card Number', type: 'text' },
      { id: 'physicalAddress', label: 'Physical Residence or Business Address', mappedField: 'Owner Address 1', type: 'text', required: true },
      ...
      { id: 'lienholderAddress', label: 'Lienholder Business Address', mappedField: 'Lienholder Address 1', type: 'text' },
  ...
  'Arizona': {
    ...
    fields: [
      ...
      { id: 'ownerName', label: 'Owner/Company Name', mappedField: 'Owner Last Name', type: 'text', required: true },
      { id: 'driverLicense', label: 'Driver License or EIN', type: 'text' },
      { id: 'dateOfBirth', label: 'Date of Birth', type: 'date' },
      { id: 'residentialAddress', label: 'Residential/Business Address', mappedField: 'Owner Address 1', type: 'text', required: true },
      { id: 'city', label: 'City', type: 'text', required: true },
      { id: 'state', label: 'State', type: 'text', required: true },
  ...
  'Michigan': {
    ...
    fields: [
      ...
      { id: 'ownerName', label: 'Owner Name (First, Middle, Last)', mappedField: 'Owner First Name', type: 'text', required: true },
      ...
      { id: 'outOfStateAddress', label: 'Out-of-State Mailing Address', mappedField: 'Owner Address 1', type: 'text' },
...
const DEFAULT_FORM = {
  ...
  fields: [
    ...
    { id: 'ownerName', label: 'Owner Name', mappedField: 'Owner First Name', type: 'text' as const, required: true },
    { id: 'ownerAddress', label: 'Owner Address', mappedField: 'Owner Address 1', type: 'text' as const },
