...
const simulateExtraction = async (
  ...
  const vehicle1Data: Record<string, { value: string | null; confidence: number; page: number }> = {
    ...
    'License Plate': { value: '8ABC123', confidence: 90, page: 1 },
    'Asset Description': { value: '2024 Honda Accord Sedan', confidence: 85, page: 1 },
    ...
    'Owner First Name': { value: 'John', confidence: 85, page: 1 },
    'Owner Last Name': { value: 'Smith', confidence: 87, page: 1 },
    'Owner Address 1': { value: '1234 Main Street', confidence: 82, page: 1 },
    'Owner Address 2': { value: null, confidence: 0, page: 1 },
    'Owner City': { value: 'Anytown', confidence: 80, page: 1 },
    'Owner State': { value: 'CA', confidence: 90, page: 1 },
    'Owner Zipcode': { value: '12345', confidence: 88, page: 1 },
    'Co-Owner First Name': { value: null, confidence: 0, page: 1 },
    'Co-Owner Last Name': { value: null, confidence: 0, page: 1 },
    'Co-Owner Address 1': { value: null, confidence: 0, page: 1 },
    'Co-Owner Address 2': { value: null, confidence: 0, page: 1 },
    'Co-Owner City': { value: null, confidence: 0, page: 1 },
    'Co-Owner State': { value: null, confidence: 0, page: 1 },
    'Co-Owner Zipcode': { value: null, confidence: 0, page: 1 },
    'Lienholder Name': { value: 'First National Bank', confidence: 82, page: 1 },
    'Lienholder Address 1': { value: 'PO Box 12345', confidence: 75, page: 1 },
    'Lienholder Address 2': { value: null, confidence: 0, page: 1 },
    'Lienholder City': { value: 'Finance City', confidence: 70, page: 1 },
    'Lienholder State': { value: 'FC', confidence: 72, page: 1 },
    'Lienholder Zipcode': { value: '54321', confidence: 65, page: 1 },
    ...
    'Brand': { value: null, confidence: 0, page: 1 },
  ...
  const vehicle2Data: Record<string, { value: string | null; confidence: number; page: number }> = {
    ...
    'License Plate': { value: 'TSLA001', confidence: 88, page: 2 },
    'Asset Description': { value: '2023 Tesla Model S Hatchback', confidence: 86, page: 2 },
    ...
    'Owner First Name': { value: 'Jane', confidence: 88, page: 2 },
    'Owner Last Name': { value: 'Doe', confidence: 90, page: 2 },
    'Owner Address 1': { value: '5678 Oak Avenue', confidence: 85, page: 2 },
    'Owner Address 2': { value: null, confidence: 0, page: 2 },
    'Owner City': { value: 'Las Vegas', confidence: 87, page: 2 },
    'Owner State': { value: 'NV', confidence: 92, page: 2 },
    'Owner Zipcode': { value: '89101', confidence: 90, page: 2 },
    'Co-Owner First Name': { value: null, confidence: 0, page: 2 },
    'Co-Owner Last Name': { value: null, confidence: 0, page: 2 },
    'Co-Owner Address 1': { value: null, confidence: 0, page: 2 },
    'Co-Owner Address 2': { value: null, confidence: 0, page: 2 },
    'Co-Owner City': { value: null, confidence: 0, page: 2 },
    'Co-Owner State': { value: null, confidence: 0, page: 2 },
    'Co-Owner Zipcode': { value: null, confidence: 0, page: 2 },
    'Lienholder Name': { value: null, confidence: 0, page: 2 },
    'Lienholder Address 1': { value: null, confidence: 0, page: 2 },
    'Lienholder Address 2': { value: null, confidence: 0, page: 2 },
    'Lienholder City': { value: null, confidence: 0, page: 2 },
    'Lienholder State': { value: null, confidence: 0, page: 2 },
    'Lienholder Zipcode': { value: null, confidence: 0, page: 2 },
    ...
    'Brand': { value: null, confidence: 0, page: 2 },
  ...
  const vehicle3Data: Record<string, { value: string | null; confidence: number; page: number }> = {
    ...
    'License Plate': { value: 'DGE7782', confidence: 87, page: 1 },
    'Asset Description': { value: '2022 Dodge Challenger Coupe', confidence: 84, page: 1 },
    ...
    'Owner First Name': { value: 'Robert', confidence: 87, page: 1 },
    'Owner Last Name': { value: 'Wilson', confidence: 89, page: 1 },
    'Owner Address 1': { value: '9012 Pine Road', confidence: 82, page: 1 },
    'Owner Address 2': { value: null, confidence: 0, page: 1 },
    'Owner City': { value: 'Dallas', confidence: 85, page: 1 },
    'Owner State': { value: 'TX', confidence: 90, page: 1 },
    'Owner Zipcode': { value: '75201', confidence: 88, page: 1 },
    'Co-Owner First Name': { value: 'Sarah', confidence: 80, page: 1 },
    'Co-Owner Last Name': { value: 'Wilson', confidence: 82, page: 1 },
    'Co-Owner Address 1': { value: '9012 Pine Road', confidence: 79, page: 1 },
    'Co-Owner Address 2': { value: null, confidence: 0, page: 1 },
    'Co-Owner City': { value: 'Dallas', confidence: 81, page: 1 },
    'Co-Owner State': { value: 'TX', confidence: 85, page: 1 },
    'Co-Owner Zipcode': { value: '75201', confidence: 83, page: 1 },
    'Lienholder Name': { value: 'Chase Auto Finance', confidence: 84, page: 1 },
    'Lienholder Address 1': { value: '1111 Bank Street', confidence: 79, page: 1 },
    'Lienholder Address 2': { value: null, confidence: 0, page: 1 },
    'Lienholder City': { value: 'Houston', confidence: 80, page: 1 },
    'Lienholder State': { value: 'TX', confidence: 85, page: 1 },
    'Lienholder Zipcode': { value: '77001', confidence: 78, page: 1 },
